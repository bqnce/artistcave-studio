...
import { supabase } from "@/prisma/supabase"; // Supabase import
import { 
  UserIcon, 
  Mail01Icon, 
  SmartPhone01Icon, 
...
export default function RegisterPage() {
  ...
  // Állapotok a hibaüzenetekhez és a betöltéshez
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // 2. Sikeres regisztráció után átirányítás a főoldalra
    alert("Sikeres regisztráció! Üdv a barlangban.");
    router.push("/"); 
  };
